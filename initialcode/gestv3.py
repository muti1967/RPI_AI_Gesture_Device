...
class PAJ7620U2(object):
    ...
    # Add a global flag to track if the next gesture should be ignored
    ignore_next_gesture = False

    def check_gesture(self):
        global current_task, ignore_next_gesture

        Gesture_Data = self._read_u16(0x43)

        # Check if we need to ignore the next gesture
        if ignore_next_gesture:
            print("Ignoring gesture..................................................")
            ignore_next_gesture = False
            return Gesture_Data
        ...
        if Gesture_Data == PAJ_UP:
            ...
            print(f"Current time: {current_time}....................................Forward")
            ignore_next_gesture = True  # Set the flag to ignore the next gesture
        elif Gesture_Data == PAJ_BACKWARD:
            print("Backward gesture detected.........................................Backward")
            ignore_next_gesture = True  # Set the flag to ignore the next gesture
