...
class PAJ7620U2(object):
    ...
    def check_gesture(self):
        ...
        if Gesture_Data == PAJ_UP:
            print(f"Playing task[{current_task}]....................................Up")
        elif Gesture_Data == PAJ_DOWN:
            print(f"Stopping task[{current_task}]...................................Down")
        elif Gesture_Data == PAJ_LEFT:
            current_task = max(1, current_task - 1)
            print(f"Moving to task[{current_task}]...................................Left")
        elif Gesture_Data == PAJ_RIGHT:
            current_task += 1
            print(f"Moving to task[{current_task}]...................................Right")
        elif Gesture_Data == PAJ_FORWARD:
            current_time = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())  # don't know what to use this for yet
            print(f"Current time: {current_time}....................................Forward")                        # added small delay so it does not capture backward gesture
            time.sleep(1.0)                                                            # can use this maybe to edit time? not sure yet#can use this maybe to edit time? not sure yet
        elif Gesture_Data == PAJ_BACKWARD:
            print("Backward gesture detected.........................................Backward")  # dont know what to use this for yet
            # not using this stuff below its pretty innacurate tbh..
            # elif Gesture_Data == PAJ_CLOCKWISE:
            #     print("Clockwise gesture detected -- Clockwise")
            # elif Gesture_Data == PAJ_COUNT_CLOCKWISE:
            #     print("AntiClockwise gesture detected -- AntiClockwise")
        return Gesture_Data
